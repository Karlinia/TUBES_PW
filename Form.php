...
<body>
    ...
    <div class="container"> <a class="navbar-brand text-primary bg-primary" href="#">
      ...
      <div class="collapse navbar-collapse" id="navbar4">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item bg-light"> <a class="nav-link" href="#">Home</a> </li>
          <li class="nav-item bg-light"> <a class="nav-link" href="#">Alamat</a> </li>
        </ul> <a class="btn navbar-btn ml-md-2 btn-light"><i class="fa fa-user fa-fw"></i>Log Out</a>
      </div>
    </div>
  </nav>
  <div class="py-5 text-center" >
    <div class="container">
      <div class="row">
        <div class="mx-auto col-lg-6 col-10" style="">
          ...
          <form class="text-left">
            ...
            <div class="form-group"> <label for="kelas">Kelas :</label> <input type="text" class="form-control" id="kelas" placeholder="Masukan Kelas Anda ......"> </div>
            ...
            <div class="card text-center">
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-link">Upload Foto</a>
              </div>
            </div>
          </form>
        </div>
      ...
      <br>
      <div class="row">
        <div class="col-md-12"><a class="btn btn-primary" href="#">Kirim Bukti Pembayaran</a></div>
      </div>
    </div>
  </div>
  <div class="py-3 bg-primary">
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-6 p-3 bg-light">
          <h5> <b>Main</b> </h5>
        ...
        <div class="col-lg-3 col-md-6 p-3 bg-light">
          <h5> <b>About</b> </h5>
