...
<body>
  ...
  <div class="py-5 bg-primary">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="card"> <img class="card-img-top" src="../img/Datatesti.jpeg" alt="testimoni">
            <div class="card-body">
              <h4 class="card-title">Lihat Data Testimoni</h4>
               <a href="datatesti.php" class="btn btn-primary">Lihat</a>
            </div>
          </div>
        </div>
        <div class="col-md-5">
          <div class="card"> <img class="card-img-top" src="../img/Datatrans.jpeg" alt="transaksi">
            <div class="card-body">
              <h4 class="card-title">Lihat Data Transaksi</h4>
